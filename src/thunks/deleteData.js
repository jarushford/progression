  ...
  return async (dispatch) => {
    try {
      ...
      type === 'journal' || type === 'milestone'
        ? url = `https://progression-backend.herokuapp.com/api/progressionusers/${user_id}/projects/${project_id}/${type}s/${item_id}`
        : url = `https://progression-backend.herokuapp.com/api/progressionusers/${user_id}/${type}s/${item_id}`
